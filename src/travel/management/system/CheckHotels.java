...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        String[] text = new String[]{"JW Marriott", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Jaiswal Hotel","Happy Morning Motel"};
        try{
            for (int i = 0; i < 9 ; i++) {
    ...
    CheckHotels(){
        ...
        Image[] jimage = new Image[]{j1, j2, j3, j4, j5, j6, j7, j8, j9, j9, j10};
